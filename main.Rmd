...
U <- cbind(rep(0,3), diag(3))
o1 <- constrOptim(c(4.5, 1, 0.1, 0.1), ui = U, ci = c(0, 0, 0), f = mse,
                  values = values, grad = NULL)
o2 <- optim(c(0, 1, 0, 0), mse, values = values)
U <- rbind(c(-1, 0, 0, 0), diag(4))
o3 <- constrOptim(c(4.5, 1, 0.1, 0.1), mse, NULL, U, c(-10, 0, 0, 0, 0),
                  values = values)
```
